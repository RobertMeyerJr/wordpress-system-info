...
<div id=options>
    ...
    <label>Show Created Date<input type=checkbox id=show_created checked value=1></label>
    <label>Show Modified Date<input type=checkbox id=show_modified value=1></label>
    <label>Show Author<input type=checkbox id=show_author value=1></label>
    <label>Show Template<input type=checkbox id=show_tpl checked value=1></label>
...
function child_tree($page, $pages, $level=0){
    ...
    <li class="level-<?=$level?> <?=implode($liClasses)?>">
        ...
        <span title="<?=esc_attr($tpl)?>" class="template pull-right text-muted">
        ...
        <span class="dates cGreen pull-right">
                ...
                ?>
                <span title="<?=esc_attr($title)?>" class="text-green">
