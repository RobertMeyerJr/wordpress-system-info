...
<div id=dbg_bar>
	<div class=dbg-nav>
		...
		<ul class=tabs>
			...
			<li class=current><a href=#dbg_console><i class=fa-info></i> Console</a></li>
			<li><a href=#dbg_info><i class=fa-info></i> Info</a></li>
			...
			<li class='right stats'><i class=fa-></i> <?php echo number_format(memory_get_usage()/1024,0) ?>KB</li>		
	...
	<div class=dbg_body>	
		...
		<div class="panel active" id=dbg_console><?php include('console.php');?></div>		
		<div class=panel id=dbg_info><?php include('info.php');?></div>		
